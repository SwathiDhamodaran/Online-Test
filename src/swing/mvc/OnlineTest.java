...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5:Which option is false about the final keyword?");
			jb[0].setText("A final method cannot be overridden in its subclasses.");jb[1].setText("A final class cannot be extended.");jb[2].setText("A final class cannot extend other classes.");jb[3].setText("A final method can be inherited.");
		}
		if(current==5)
		{
